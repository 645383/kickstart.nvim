...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      statusline.section_filename = function()
        -- Use '%:p:.' to get the absolute file path relative to the current directory.
      ...
      statusline.section_fileinfo = function()
        -- I want to show file type and size
        local fileinfo = vim.bo.filetype
        local size = vim.fn.getfsize(vim.fn.expand '%:p')
        if size > 0 then
          fileinfo = fileinfo .. ' ' .. byte2human(size)
        end
        return fileinfo
      end

      function byte2human(size)
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'ruby', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc' },
